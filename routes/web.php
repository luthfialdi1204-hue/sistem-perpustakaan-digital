...
use App\Http\Controllers\Admin\KelolaAnggotaAdminController;
use App\Http\Controllers\Admin\KelolaBukuAdminController;
use App\Http\Controllers\Admin\KelolaPeminjamanAdminController;
use App\Http\Controllers\Admin\LaporanAdminController;
use App\Http\Controllers\Admin\ProfilController as AdminProfilController;
use App\Http\Controllers\Mahasiswa\Katalog_Buku;
...
Route::middleware(['auth', 'role:mahasiswa'])->group(function () {
    ...
    Route::get('/Profil_Mahasiswa', [MahasiswaProfilController::class, 'mahasiswa'])->name('mahasiswa.profil');
    Route::post('/profil/foto', [MahasiswaProfilController::class, 'uploadFoto'])->name('mahasiswa.profil.foto');
    Route::delete('/profil/foto', [MahasiswaProfilController::class, 'hapusFoto'])->name('mahasiswa.profil.foto.hapus');
});
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Profil Admin
    Route::get('/Profil_Admin', [AdminProfilController::class, 'admin'])->name('admin.profil');
    Route::post('/admin/profil/foto', [AdminProfilController::class, 'uploadFoto'])->name('admin.profil.foto');
    Route::delete('/admin/profil/foto', [AdminProfilController::class, 'hapusFoto'])->name('admin.profil.foto.hapus');
});
