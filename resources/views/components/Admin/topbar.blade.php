...
<div class="mb-6 flex items-center justify-between">
  ...
  <div class="relative">
    <button id="userMenuButton" type="button"
      ...
      <div class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-700 font-semibold">AD</div>
    ...
    <div id="userDropdown"
      ...
      <a href="/Profil_Admin" class="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 transition text-sm">Profil</a>
